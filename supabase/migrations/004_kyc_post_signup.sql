-- =============================================================================
-- Northium Credit Union — Post-signup KYC, account type selection
-- =============================================================================

ALTER TABLE public.pending_signups
  ALTER COLUMN ssn_encrypted DROP NOT NULL,
  ALTER COLUMN ssn_last_four DROP NOT NULL,
  ALTER COLUMN id_document_type DROP NOT NULL,
  ALTER COLUMN id_document_number_encrypted DROP NOT NULL,
  ALTER COLUMN id_document_last_four DROP NOT NULL;

ALTER TABLE public.pending_signups
  ADD COLUMN IF NOT EXISTS requested_account_types public.account_type[]
    NOT NULL DEFAULT ARRAY['checking']::public.account_type[];
...
ALTER TABLE public.kyc_verifications
  ADD COLUMN IF NOT EXISTS id_document_front_encrypted TEXT,
  ADD COLUMN IF NOT EXISTS id_document_back_encrypted TEXT;
